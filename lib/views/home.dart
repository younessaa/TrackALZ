...
class _HomeState extends State<Home> {
  ...
  Container mapText(Size size) {
    return Container(
                  ...
                  decoration: !isShadowText ? null : BoxDecoration(
                    border: Border(
                  ...
                  child: Center(
                    child: GestureDetector(
                      ...
                      child: Text(
                        "Map",
                        style: TextStyle(
                          color: !isShadowText ? Color(0xFF565656).withOpacity(0.8) : Color(0xFF291F1F).withOpacity(0.8),
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
                          shadows: !isShadowText ? [] :  <Shadow>[
                            Shadow(
                              offset: Offset(0, 4),
                              blurRadius: 4.0,
    ...
    return ListView(
          children: [
            GestureDetector(
              ...
              child: semelle(size, "Grand-mère", "assets/images/grandma.png", "Connecté")
            ),
            GestureDetector(
              onTap : () {
                Navigator.pushNamed(context, "/DetailsSemelle");
              },
              child: semelle(size, "Grand-père", "assets/images/grandfa.png", "Non-connecté")
            ),
          ]
        );
  }

  Container semelle(Size size, String name, String imageUrl, String connectStatus) {
    return Container(
              ...
              Row(
                children : [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(100),
                      color: connectStatus == "Connecté" ? Color(0xFF4CB627) : Color(0xFFFF0000),
                    ),
                  ),
                  Padding(
